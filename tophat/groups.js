...
const groups = {
    ...
    // unicode blocks
    basiclatin: { components: ["basiclatin"], ...uni.basiclatin}, latin1supp: { components: ["latin1supp"], ...uni.latin1supp},
    latinext_a: { components: ["latinext_a"], ...uni.latinext_a}, latinext_b: { components: ["latinext_b"], ...uni.latinext_b},
    ipa_extens: { components: ["ipa_extens"], ...uni.ipa_extens}, spacingmod: { components: ["spacingmod"], ...uni.spacingmod},
    comb_diacr: { components: ["comb_diacr"], ...uni.comb_diacr}, greek_copt: { components: ["greek_copt"], ...uni.greek_copt},
    cyrillic:   { components: ["cyrillic"  ], ...uni.cyrillic  }, cyril_supp: { components: ["cyril_supp"], ...uni.cyril_supp},
    armenian:   { components: ["armenian"  ], ...uni.armenian  }, hebrew:     { components: ["hebrew"    ], ...uni.hebrew    },
    arabic:     { components: ["arabic"    ], ...uni.arabic    }, syriac:     { components: ["syriac"    ], ...uni.syriac    },
    arabic_sup: { components: ["arabic_sup"], ...uni.arabic_sup}, thaana:     { components: ["thaana"    ], ...uni.thaana    },
    nko:        { components: ["nko"       ], ...uni.nko       }, samaritan:  { components: ["samaritan" ], ...uni.samaritan },
    mandaic:    { components: ["mandaic"   ], ...uni.mandaic   }, syriac_sup: { components: ["syriac_sup"], ...uni.syriac_sup},
    arabic_x_b: { components: ["arabic_x_b"], ...uni.arabic_x_b}, arabic_x_a: { components: ["arabic_x_a"], ...uni.arabic_x_a},
    devanagari: { components: ["devanagari"], ...uni.devanagari}, bengali:    { components: ["bengali"   ], ...uni.bengali   },
    gurmukhi:   { components: ["gurmukhi"  ], ...uni.gurmukhi  }, gujarati:   { components: ["gujarati"  ], ...uni.gujarati  },
    oriya:      { components: ["oriya"     ], ...uni.oriya     }, tamil:      { components: ["tamil"     ], ...uni.tamil     },
    telugu:     { components: ["telugu"    ], ...uni.telugu    }, kannada:    { components: ["kannada"   ], ...uni.kannada   },
    malayalam:  { components: ["malayalam" ], ...uni.malayalam }, sinhala:    { components: ["sinhala"   ], ...uni.sinhala   },
    thai:       { components: ["thai"      ], ...uni.thai      }, lao:        { components: ["lao"       ], ...uni.lao       },
    tibetan:    { components: ["tibetan"   ], ...uni.tibetan   }, myanmar:    { components: ["myanmar"   ], ...uni.myanmar   },
    georgian:   { components: ["georgian"  ], ...uni.georgian  }, hanguljamo: { components: ["hanguljamo"], ...uni.hanguljamo},
    ethiopic:   { components: ["ethiopic"  ], ...uni.ethiopic  }, ethiopic_s: { components: ["ethiopic_s"], ...uni.ethiopic_s},
    cherokee:   { components: ["cherokee"  ], ...uni.cherokee  }, u_c_ab_syl: { components: ["u_c_ab_syl"], ...uni.u_c_ab_syl},
    ogham:      { components: ["ogham"     ], ...uni.ogham     }, runic:      { components: ["runic"     ], ...uni.runic     },
    tagalog:    { components: ["tagalog"   ], ...uni.tagalog   }, hanunoo:    { components: ["hanunoo"   ], ...uni.hanunoo   },
    buhid:      { components: ["buhid"     ], ...uni.buhid     }, tagbanwa:   { components: ["tagbanwa"  ], ...uni.tagbanwa  },
    khmer:      { components: ["khmer"     ], ...uni.khmer     }, mongolian:  { components: ["mongolian" ], ...uni.mongolian },
    u_c_ab_s_x: { components: ["u_c_ab_s_x"], ...uni.u_c_ab_s_x}, limbu:      { components: ["limbu"     ], ...uni.limbu     },
    tai_le:     { components: ["tai_le"    ], ...uni.tai_le    }, new_tai_lu: { components: ["new_tai_lu"], ...uni.new_tai_lu},
    khmer_symb: { components: ["khmer_symb"], ...uni.khmer_symb}, buginese:   { components: ["buginese"  ], ...uni.buginese  },
    tai_tham:   { components: ["tai_tham"  ], ...uni.tai_tham  }, com_di_m_x: { components: ["com_di_m_x"], ...uni.com_di_m_x},
    balinese:   { components: ["balinese"  ], ...uni.balinese  }, sundanese:  { components: ["sundanese" ], ...uni.sundanese },
    batak:      { components: ["batak"     ], ...uni.batak     }, lepcha:     { components: ["lepcha"    ], ...uni.lepcha    },
    ol_chiki:   { components: ["ol_chiki"  ], ...uni.ol_chiki  }, cyrl_ext_c: { components: ["cyrl_ext_c"], ...uni.cyrl_ext_c},
    georgian_x: { components: ["georgian_x"], ...uni.georgian_x}, sundanes_s: { components: ["sundanes_s"], ...uni.sundanes_s},
    vedic_exts: { components: ["vedic_exts"], ...uni.vedic_exts}, phonet_ext: { components: ["phonet_ext"], ...uni.phonet_ext},
    ph_ext_sup: { components: ["ph_ext_sup"], ...uni.ph_ext_sup}, com_di_sup: { components: ["com_di_sup"], ...uni.com_di_sup},
    lat_ext_ad: { components: ["lat_ext_ad"], ...uni.lat_ext_ad}, greek_extd: { components: ["greek_extd"], ...uni.greek_extd},
    gener_punc: { components: ["gener_punc"], ...uni.gener_punc}, sup_subscr: { components: ["sup_subscr"], ...uni.sup_subscr},
    curr_symbs: { components: ["curr_symbs"], ...uni.curr_symbs}, com_di_sym: { components: ["com_di_sym"], ...uni.com_di_sym},
    letterlike: { components: ["letterlike"], ...uni.letterlike}, numberform: { components: ["numberform"], ...uni.numberform},
    arrows:     { components: ["arrows"    ], ...uni.arrows    }, mathoperat: { components: ["mathoperat"], ...uni.mathoperat},
    misc_techn: { components: ["misc_techn"], ...uni.misc_techn}, controlpic: { components: ["controlpic"], ...uni.controlpic},
    opt_ch_rec: { components: ["opt_ch_rec"], ...uni.opt_ch_rec}, enclos_alp: { components: ["enclos_alp"], ...uni.enclos_alp},
    boxdrawing: { components: ["boxdrawing"], ...uni.boxdrawing}, blockelems: { components: ["blockelems"], ...uni.blockelems},
    geomshapes: { components: ["geomshapes"], ...uni.geomshapes}, misc_symbs: { components: ["misc_symbs"], ...uni.misc_symbs},
    dingbats:   { components: ["dingbats"  ], ...uni.dingbats  }, miscmath_a: { components: ["miscmath_a"], ...uni.miscmath_a},
    supp_arr_a: { components: ["supp_arr_a"], ...uni.supp_arr_a}, braillepat: { components: ["braillepat"], ...uni.braillepat},
    supp_arr_b: { components: ["supp_arr_b"], ...uni.supp_arr_b}, miscmath_b: { components: ["miscmath_b"], ...uni.miscmath_b},
    suppmathop: { components: ["suppmathop"], ...uni.suppmathop}, miscsymarr: { components: ["miscsymarr"], ...uni.miscsymarr},
    glagolitic: { components: ["glagolitic"], ...uni.glagolitic}, latinext_c: { components: ["latinext_c"], ...uni.latinext_c},
    coptic:     { components: ["coptic"    ], ...uni.coptic    }, georgian_s: { components: ["georgian_s"], ...uni.georgian_s},
    tifinagh:   { components: ["tifinagh"  ], ...uni.tifinagh  }, ethiopic_x: { components: ["ethiopic_x"], ...uni.ethiopic_x},
    cyrl_ext_a: { components: ["cyrl_ext_a"], ...uni.cyrl_ext_a}, supp_punct: { components: ["supp_punct"], ...uni.supp_punct},
    cjkrad_sup: { components: ["cjkrad_sup"], ...uni.cjkrad_sup}, kangxi_rad: { components: ["kangxi_rad"], ...uni.kangxi_rad},
    ideodescch: { components: ["ideodescch"], ...uni.ideodescch}, cjksympunc: { components: ["cjksympunc"], ...uni.cjksympunc},
    hiragana:   { components: ["hiragana"  ], ...uni.hiragana  }, katakana:   { components: ["katakana"  ], ...uni.katakana  },
    bopomofo:   { components: ["bopomofo"  ], ...uni.bopomofo  }, hangul_c_j: { components: ["hangul_c_j"], ...uni.hangul_c_j},
    kanbun:     { components: ["kanbun"    ], ...uni.kanbun    }, bopomofo_x: { components: ["bopomofo_x"], ...uni.bopomofo_x},
    cjk_stroke: { components: ["cjk_stroke"], ...uni.cjk_stroke}, katakana_x: { components: ["katakana_x"], ...uni.katakana_x},
    enclos_cjk: { components: ["enclos_cjk"], ...uni.enclos_cjk}, cjk_compat: { components: ["cjk_compat"], ...uni.cjk_compat},
    ...
    yijing_hex: { components: ["yijing_hex"], ...uni.yijing_hex},
    ...
    yi_syllabl: { components: ["yi_syllabl"], ...uni.yi_syllabl}, yi_radical: { components: ["yi_radical"], ...uni.yi_radical},
    lisu:       { components: ["lisu"      ], ...uni.lisu      }, vai:        { components: ["vai"       ], ...uni.vai       },
    cyrl_ext_b: { components: ["cyrl_ext_b"], ...uni.cyrl_ext_b}, bamum:      { components: ["bamum"     ], ...uni.bamum     },
    modif_tone: { components: ["modif_tone"], ...uni.modif_tone}, latinext_d: { components: ["latinext_d"], ...uni.latinext_d},
    sylotinagr: { components: ["sylotinagr"], ...uni.sylotinagr}, comm_indic: { components: ["comm_indic"], ...uni.comm_indic},
    phags_pa:   { components: ["phags_pa"  ], ...uni.phags_pa  }, saurashtra: { components: ["saurashtra"], ...uni.saurashtra},
    dvngri_ext: { components: ["dvngri_ext"], ...uni.dvngri_ext}, kayah_li:   { components: ["kayah_li"  ], ...uni.kayah_li  },
    rejang:     { components: ["rejang"    ], ...uni.rejang    }, hngljm_x_a: { components: ["hngljm_x_a"], ...uni.hngljm_x_a},
    javanese:   { components: ["javanese"  ], ...uni.javanese  }, myanmar_xb: { components: ["myanmar_xb"], ...uni.myanmar_xb},
    cham:       { components: ["cham"      ], ...uni.cham      }, myanmar_xa: { components: ["myanmar_xa"], ...uni.myanmar_xa},
    tai_viet:   { components: ["tai_viet"  ], ...uni.tai_viet  }, meeteimayx: { components: ["meeteimayx"], ...uni.meeteimayx},
    ethiopicxa: { components: ["ethiopicxa"], ...uni.ethiopicxa}, latinext_e: { components: ["latinext_e"], ...uni.latinext_e},
    cherokee_s: { components: ["cherokee_s"], ...uni.cherokee_s}, meeteimayk: { components: ["meeteimayk"], ...uni.meeteimayk},
    ...
    hngljm_x_b: { components: ["hngljm_x_b"], ...uni.hngljm_x_b},
    ...
    cjk_com_id: { components: ["cjk_com_id"], ...uni.cjk_com_id}, alph_presf: { components: ["alph_presf"], ...uni.alph_presf},
    arab_prf_a: { components: ["arab_prf_a"], ...uni.arab_prf_a}, var_select: { components: ["var_select"], ...uni.var_select},
    vert_forms: { components: ["vert_forms"], ...uni.vert_forms}, com_hlfmks: { components: ["com_hlfmks"], ...uni.com_hlfmks},
    cjk_com_fo: { components: ["cjk_com_fo"], ...uni.cjk_com_fo}, small_form: { components: ["small_form"], ...uni.small_form},
    arab_prf_b: { components: ["arab_prf_b"], ...uni.arab_prf_b}, half_fullw: { components: ["half_fullw"], ...uni.half_fullw},
    specials:   { components: ["specials"  ], ...uni.specials  },
